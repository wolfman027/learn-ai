...
import com.wolfman.alibaba_ai_cloud_demo.configuration.RedisChatMemory;
...
public class ChatRedisMemoryController {
    ...
    public ChatRedisMemoryController(ChatModel chatModel) {
        this.chatClient = ChatClient.builder(chatModel)
                ...
                .defaultAdvisors(new MessageChatMemoryAdvisor(new RedisChatMemory("localhost", 6379, null)))
                .build();
    }
